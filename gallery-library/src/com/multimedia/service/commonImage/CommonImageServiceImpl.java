...
public class CommonImageServiceImpl extends GenericServiceImpl<CommonImage, Long>{

	@Override
	@Resource(name="commonImageDAO")
	public void setDao(IGenericDAO<CommonImage, Long> dao) {super.setDao(dao);}
