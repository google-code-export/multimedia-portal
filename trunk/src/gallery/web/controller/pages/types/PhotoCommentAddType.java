 ...
 */
public class PhotoCommentAddType extends APagesType{
    /** string constant that represents type for this page */
    public static final String TYPE="system_photoComment_add";
	/** rus type */
	public static final String TYPE_RU="---Добавление комментария к фото---";

	private ABindValidator validator;

	private IInsertService<PhotoComment> service;
	...
	public void setViewService(IInsertService value) {this.service = value;}
