...
package com.multimedia.web.controller.wallpaper.comment;
 ...
 */
@Controller(value="wallpaperCommentCmsController")
public class CmsController extends FilterGenericCmsController<WallpaperComment>{
	protected final List<String> filterProperties = java.util.Arrays.asList("id_photo_nav");
	protected final List<String> filterAliases = java.util.Arrays.asList("this.id_photo");
