...
package com.multimedia.web.controller.commonImage;
 ...
 */
@Controller(value="commonImageCmsController")
public class CmsController extends AGenericPagesCmsController<CommonImage>{
	...
	@ModelAttribute
    public void populateImageParams(@RequestParam(value="id_item_nav", required=false) Long id_item_nav, Map<String, Object> model) {
		model.put("id_item_nav", id_item_nav);
    }

	//-------------------------------------- overriden methods from parent ------------------------

	@Resource(name="commonImageConfig")
	public void setConfig(ICmsConfig config) {this.config = config;}

	@Resource(name="cmsCommonImageService")
	public void setCmsService(ICmsService<CommonImage, Long> cmsService) {
